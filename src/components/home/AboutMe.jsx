    ...
    <Jumbotron id="aboutme" className="m-0">
      <div className="container row">
        ...
        <div className={`col-lg-${showPic ? "7" : "12"}`}>
          ...
          <p className="lead">
          Меня зовут Магомедали Магомедов. Я выпускник МАИ 2022 года по специальности 'Программная инженерия'. 
          Также в настоящее время я обучаюсь на направлении highload в МАИ.
          </p>
          <p className="lead">
